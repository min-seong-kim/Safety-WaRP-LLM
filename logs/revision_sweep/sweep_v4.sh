...
declare -A WSR_NEED=([llama32_3b]=30 [llama2_7b]=45 [llama31_8b]=50 [qwen25_7b]=50 [gemma2_9b]=78 [llama2_13b]=88)
...
log "════ sweep v4 전체 완료 ════"; echo done > "$REPO/logs/revision_sweep/sweep.rc"
